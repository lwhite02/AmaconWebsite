...
const ContactPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact Us | iControl Consulting</title>
        <meta
          name="description"
          content="Contact iControl Consulting for any inquiries or further assistance. Find our phone number, address, and email here."
        />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              name: "iControl Consulting",
              url: "https://www.icontrolconsulting.co.za",
              contactPoint: {
                "@type": "ContactPoint",
                telephone: "+27-11-782-3450",
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress:
                  "Unit 7, Verona Office Park, cnr Malibonge Drive and McArthur Ave",
                addressLocality: "Randburg",
                addressRegion: "Gauteng",
                postalCode: "2194",
                addressCountry: "ZA",
              },
              email: "info@icontrolconsulting.co.za",
            }),
          }}
        />
      </Head>
      ...
      <section className="relative z-10 overflow-hidden py-20 md:py-28">
        <div className="container relative z-10 mx-auto flex items-center justify-center pb-20 text-center md:text-left">
          <div className="max-w-xl text-center md:text-left">
            ...
            Get In Touch for Any Inquiries or Further Assistance
            </p>
          </div>
        </div>
        <div className="absolute inset-0 z-0">
          <div className="relative h-full w-full">
            <img
              src="/images/services/contactushero.webp" // Replace with your image path
      ...
      <section id="contact" className="overflow-hidden py-16 md:py-20 lg:py-28">
        <div className="container">
          <h2 className="mb-10 text-5xl font-bold text-black">
            Want to Find Out More?
          </h2>
          <p className="text-gray-700 mb-5 text-lg">
            At iControl Consulting, we offer comprehensive consulting services
            to help your business thrive. Contact us for personalized assistance
            and expert advice.
          </p>
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div
                className="wow fadeInUp mb-12 rounded-md bg-[#E1E1E1] py-11 px-8 dark:bg-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]"
                data-wow-delay=".15s"
              >
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="mb-12 rounded-md bg-[#E1E1E1] py-11 px-8 dark:bg-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                <div
                  className="mb-8"
                ...
                <div>
                  ...
                  <p className="mb-2">
                    Address: Unit 7, Verona Office Park, cnr Malibonge Drive and
                    McArthur Ave, Randburg, Gauteng
                  </p>
